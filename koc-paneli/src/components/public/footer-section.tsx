...
export function FooterSection() {
  return (
    <footer className="bg-[#090b11]">
      <div className="public-container py-16 sm:py-20">
        <div className="flex flex-col items-start justify-between gap-8 border-b border-white/[0.08] pb-12 lg:flex-row lg:items-center">
          ...
          <Link href="#paketler" className={cn(buttonVariants({ size: 'lg' }), 'public-primary-button h-12 gap-2 px-6')}>Paketleri incele <ArrowRight className="size-4" /></Link>
        </div>
