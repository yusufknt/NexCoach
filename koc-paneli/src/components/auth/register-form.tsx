    ...
    <div className="w-full max-w-md space-y-6">
      ...
      <Card className="w-full">
        <CardHeader>
          ...
          <CardDescription className="text-sm text-[#C4C9AC] space-y-1">
            <p>
              <span className="text-[#E5E1E4] font-medium">{coachName}</span> tarafından davet edildiniz.
            </p>
            {packageName && (
              <p>
                Paket: <span className="text-[#ABD600] font-medium">{packageName}</span>
              </p>
            )}
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="fullName" className="text-sm font-medium text-[#C4C9AC]">Ad Soyad</Label>
              <Input
                id="fullName"
                type="text"
            ...
            <div className="space-y-2">
              <Label htmlFor="passwordConfirm" className="text-sm font-medium text-[#C4C9AC]">Şifre Tekrar</Label>
              <Input
                id="passwordConfirm"
                type="password"
                placeholder="••••••"
