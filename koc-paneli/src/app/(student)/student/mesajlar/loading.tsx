...
export default function StudentMessagesLoading() {
  return (
    <div className="h-[calc(100vh-theme(spacing.16))] w-full bg-background p-4 md:p-6">
      <div className="flex h-full flex-col rounded-xl border border-border/80 bg-card shadow-sm">
        {/* Header Loading */}
        <div className="flex items-center gap-4 border-b border-border/80 p-4 shrink-0">
        ...
        {/* Input Loading */}
        <div className="p-4 border-t border-border/80 shrink-0 flex items-end gap-2">
